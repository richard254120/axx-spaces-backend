...
const removeRoleConstraints = async () => {
  try {
    ...
    console.log("\n Removing compound unique indexes that block role changes...");
    ...
    try {
      ...
      if (err.code === 26) {
        console.log("     Index phone_1_role_1 does not exist (already removed)");
      } else {
        console.log("     Error dropping phone_1_role_1:", err.message);
      }
    }
    ...
    try {
      ...
      if (err.code === 26) {
        console.log("     Index email_1_role_1 does not exist (already removed)");
      } else {
        console.log("     Error dropping email_1_role_1:", err.message);
      }
    }
